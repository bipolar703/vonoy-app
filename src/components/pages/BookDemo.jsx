  ...
  const GeometricDesign = () => {
    return (
      <div className="absolute left-0 bottom-0 w-full h-full overflow-hidden pointer-events-none">
        {/* Solid shape behind the first line */}
        <motion.div
        ...
        >
          <div className="w-full h-full bg-[#2A9D8F]/5 rounded-[50px]" />
          <div className="w-full h-full border-[3px] border-[#2A9D8F]/20 rounded-[50px] absolute top-0 left-0" />
        </motion.div>

        {/* Solid shape behind the second line */}
        <motion.div
        ...
        >
          <div className="w-full h-full bg-[#2A9D8F]/8 rounded-[50px]" />
          <div className="w-full h-full border-[3px] border-[#2A9D8F]/30 rounded-[50px] absolute top-0 left-0" />
        </motion.div>

        {/* Solid shape behind the third line */}
        <motion.div
        ...
        >
          <div className="w-full h-full bg-[#2A9D8F]/10 rounded-[50px]" />
          <div className="w-full h-full border-[3px] border-[#2A9D8F]/40 rounded-[50px] absolute top-0 left-0" />
        </motion.div>
      </div>
    );
  };
            ...
            >
              ...
              <motion.div className="space-y-2" variants={fadeInUp} custom={3}>
                ...
                <select
                  ...
                  style={{ color: 'white' }}
                >
                  <option value="" disabled style={{ color: '#102a43', backgroundColor: 'white' }}>
                    Select your country
                  </option>
                  <option value="ae" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    United Arab Emirates
                  </option>
                  <option value="us" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    United States
                  </option>
                  <option value="uk" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    United Kingdom
                  </option>
                  <option value="sa" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    Saudi Arabia
                  </option>
                  <option value="eg" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    Egypt
                  </option>
                </select>
              </motion.div>
              <motion.div className="space-y-2" variants={fadeInUp} custom={4}>
                ...
                >
                  ...
                  <option value="1-10" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    1-10 vehicles
                  </option>
                  <option value="11-50" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    11-50 vehicles
                  </option>
                  <option value="51-100" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    51-100 vehicles
                  </option>
                  <option value="101+" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    101+ vehicles
                  </option>
                </select>
              </motion.div>
              ...
              <motion.div className="space-y-2" variants={fadeInUp} custom={6}>
                ...
                >
                  ...
                  <option value="fmcg" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    FMCG Distribution
                  </option>
                  <option value="lastmile" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    Last-Mile Delivery
                  </option>
                  <option value="cashvan" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    Cash Van Delivery
                  </option>
                  <option value="postal" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    Postal & Courier
                  </option>
                  <option value="coldchain" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    Cold Chain & Pharma
                  </option>
                  <option value="ev" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    EV Fleet Operations
                  </option>
                  <option value="other" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    Other
                  </option>
                </select>
              </motion.div>
              <motion.div className="space-y-2" variants={fadeInUp} custom={7}>
                ...
                >
                  ...
                  <option value="fleet-management" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    Fleet Management
                  </option>
                  <option value="route-optimization" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    Route Optimization
                  </option>
                  <option value="analytics" style={{ color: '#102a43', backgroundColor: 'white' }}>
                    Analytics Platform
                  </option>
                  <option value="carbon-reduction" style={{ color: '#102a43', backgroundColor: 'white' }}>
